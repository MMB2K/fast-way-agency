    ...
    <footer className="mt-20 bg-navy-deep text-white print:hidden">
      <div className="mx-auto grid max-w-6xl gap-10 px-4 py-14 sm:px-6 md:grid-cols-3">
        <div>
          ...
          <p className="mt-4 text-sm leading-relaxed text-white/70">
            Votre partenaire de confiance pour les études à l'étranger, le tourisme médical et la
            découverte de la Mauritanie.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm text-white/80">
            <li><Link to="/" className="hover:text-orange">Accueil</Link></li>
            <li><Link to="/etudes" className="hover:text-orange">Études internationales</Link></li>
            <li><Link to="/tourisme-medical" className="hover:text-orange">Tourisme médical</Link></li>
            <li><Link to="/mauritanie" className="hover:text-orange">Mauritanie</Link></li>
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto max-w-6xl px-4 py-5 text-center text-xs text-white/50 sm:px-6">
          © {new Date().getFullYear()} Fast Way Agency. Tous droits réservés.
        </div>
      </div>
    </footer>
  );
